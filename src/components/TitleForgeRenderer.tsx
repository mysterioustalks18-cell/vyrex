               ...
               {expandedTitles.includes(title.rank) && (
                 ...
                 >
                    <div className="p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                       ...
                       <div className="md:col-span-4 bg-[#080d18] border border-white/5 rounded-2xl p-4 space-y-4 relative overflow-hidden group/sim shadow-2xl">
                         <div className="flex items-center justify-between mb-2">
                           <span className="font-mono text-[8px] text-vy-muted uppercase tracking-widest">SEARCH SIMULATOR</span>
                           <div className="flex gap-1">
                              {[1, 2, 3].map(i => <div key={i} className="w-1 h-1 rounded-full bg-white/10" />)}
                           </div>
                         </div>
                         <div className="flex gap-3">
                            <div className="w-20 aspect-video bg-white/5 rounded-lg shrink-0 overflow-hidden relative border border-white/5">
                               <div className="absolute inset-0 bg-gradient-to-br from-vy-accent/10 to-transparent" />
                               <div className="absolute inset-0 flex items-center justify-center p-1 text-center scale-75">
                                  <span className="font-display font-black text-[7px] text-white leading-none uppercase italic">{title.thumbnailText}</span>
                               </div>
                            </div>
                            <div className="flex-1 space-y-1.5 py-1 min-w-0">
                               <div className="h-1.5 w-full bg-white/90 rounded" />
                         ...
                         <div className="absolute inset-0 border border-vy-cyan/0 group-hover/sim:border-vy-cyan/20 transition-all rounded-2xl pointer-events-none" />
                       </div>
                    </div>
                 </motion.div>
               )}
