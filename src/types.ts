...
export interface AiPreferences {
  ...
  scriptStyle: 'STORYTELLER' | 'TECHNICAL' | 'HYPER-GROWTH' | 'CINEMATIC' | 'MINIMALIST';
}
...
export interface AssetForgeResult {
  ...
  bRollBlueprint: {
    section: number;
    visualCues: string[];
    motionType: 'Static' | 'Slow Pan' | 'Rapid Cut' | 'Zoom';
    overlayIdea: string;
  }[];
...
export interface HookAnalyzerResult {
  ...
  eyeTrackingHeatmap?: string;
  audienceRetentionPrediction?: string;
}
